...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Futibet" },
      { name: "description", content: "Premium AI-powered football intelligence and analytics platform." },
      { property: "og:title", content: "Futibet" },
      { property: "og:description", content: "Premium AI-powered football intelligence and analytics platform." },
